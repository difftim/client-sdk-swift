...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/chative/webrtc-xcframework.git", exact: "144.7559.04"),
        ...
        .package(url: "https://github.com/3th1UOYgUtJkurSZ/ttsignal-xcframework.git", exact: "1.0.20260508-1"),
