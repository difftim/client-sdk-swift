...
protocol SignalClientDelegate: AnyObject, Sendable {
    ...
    func signalClient(_ signalClient: SignalClient, didReceiveLeave canReconnect: Bool, action: Livekit_LeaveRequest.Action, reason: Livekit_DisconnectReason, regions: Livekit_RegionSettings?) async
