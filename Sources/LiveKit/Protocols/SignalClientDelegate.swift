...
protocol SignalClientDelegate: AnyObject, Sendable {
    ...
    func signalClient(_ signalClient: SignalClient, didReceiveLeave canReconnect: Bool, reason: Livekit_DisconnectReason, action: Livekit_LeaveRequest.Action) async
