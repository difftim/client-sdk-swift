...
extension Room: SignalClientDelegate {
    ...
    func signalClient(_: SignalClient, didReceiveLeave canReconnect: Bool, action: Livekit_LeaveRequest.Action, reason: Livekit_DisconnectReason, regions: Livekit_RegionSettings?) async {
        log("canReconnect: \(canReconnect), action: \(action), reason: \(reason)")
